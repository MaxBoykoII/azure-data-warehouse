...
parser.add_argument("host", help="Specifies the host of the postgres db")
parser.add_argument("user", help="Specifies the admin username")
parser.add_argument("password", help="Specifies the admin password")
...
cursor = conn.cursor()
cursor.execute("DROP DATABASE IF EXISTS divvy")
cursor.execute("CREATE DATABASE divvy")
